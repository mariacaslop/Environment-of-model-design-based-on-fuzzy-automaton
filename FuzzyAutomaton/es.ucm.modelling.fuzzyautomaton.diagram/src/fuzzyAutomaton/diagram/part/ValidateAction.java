...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(fuzzyAutomaton.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		fuzzyAutomaton.diagram.providers.FuzzyAutomatonValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			fuzzyAutomaton.diagram.providers.FuzzyAutomatonMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorUtil.findView(diagramEditPart,
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		fuzzyAutomaton.diagram.providers.FuzzyAutomatonMarkerNavigationProvider.addMarker(target, elementId, location,
