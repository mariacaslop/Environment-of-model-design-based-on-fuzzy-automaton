 ...
 * @generated
 */
public class FuzzyAutomatonValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && fuzzyAutomaton.diagram.edit.parts.FuzzyAutomatonEditPart.MODEL_ID
