 ...
 * @generated
 */
public class FuzzyAutomatonMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorUtil.selectElementsInDiagram(editor,
