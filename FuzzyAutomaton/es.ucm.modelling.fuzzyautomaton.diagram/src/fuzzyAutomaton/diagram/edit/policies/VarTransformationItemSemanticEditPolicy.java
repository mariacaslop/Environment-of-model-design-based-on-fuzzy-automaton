 ...
 * @generated
 */
public class VarTransformationItemSemanticEditPolicy
		extends fuzzyAutomaton.diagram.edit.policies.FuzzyAutomatonBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public VarTransformationItemSemanticEditPolicy() {
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (fuzzyAutomaton.diagram.part.FuzzyAutomatonVisualIDRegistry.getVisualID(node)) {
			case fuzzyAutomaton.diagram.edit.parts.VarTransformationVarTransformationVarUpdatesCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					switch (fuzzyAutomaton.diagram.part.FuzzyAutomatonVisualIDRegistry.getVisualID(cnode)) {
