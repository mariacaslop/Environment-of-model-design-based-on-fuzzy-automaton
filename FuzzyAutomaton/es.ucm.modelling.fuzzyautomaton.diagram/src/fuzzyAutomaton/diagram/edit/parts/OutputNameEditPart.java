	...
	*/
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			...
			Output output = (Output) parserElement;

			if (output.getName() != null && output.getExpression() != null) {

				text = output.getName() + "(";

				List<String> expressions = output.getExpression();
	...
	public IParser getParser() {
		if (parser == null) {
			parser = fuzzyAutomaton.diagram.providers.FuzzyAutomatonParserProvider.getParser(
					fuzzyAutomaton.diagram.providers.FuzzyAutomatonElementTypes.Output_3003, getParserElement(),
