 ...
 * @generated
 */
public class FuzzyConstraintNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FuzzyConstraintNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = fuzzyAutomaton.diagram.providers.FuzzyAutomatonParserProvider.getParser(
					...
					getParserElement(), fuzzyAutomaton.diagram.part.FuzzyAutomatonVisualIDRegistry
							.getType(fuzzyAutomaton.diagram.edit.parts.FuzzyConstraintNameEditPart.VISUAL_ID));
		}
		return parser;
	}
