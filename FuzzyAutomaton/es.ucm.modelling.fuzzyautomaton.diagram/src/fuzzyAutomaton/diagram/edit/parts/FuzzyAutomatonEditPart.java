 ...
 * @generated
 */
public class FuzzyAutomatonEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "FuzzyAutomaton"; //$NON-NLS-1$
	...
	* @generated
	*/
	public FuzzyAutomatonEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new fuzzyAutomaton.diagram.edit.policies.FuzzyAutomatonItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new fuzzyAutomaton.diagram.edit.policies.FuzzyAutomatonCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new fuzzyAutomaton.diagram.edit.commands.FuzzyAutomatonCreateShortcutDecorationsCommand(
