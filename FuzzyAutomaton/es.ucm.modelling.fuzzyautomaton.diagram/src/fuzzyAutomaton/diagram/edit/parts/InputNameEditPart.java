	...
	*/
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			...
			Input input = (Input) parserElement;

			if (input.getName() != null && input.getParameters() != null) {

				text = input.getName() + "(";

				List<Variable> parameters = input.getParameters();
	...
	public IParser getParser() {
		if (parser == null) {
			parser = fuzzyAutomaton.diagram.providers.FuzzyAutomatonParserProvider.getParser(
					fuzzyAutomaton.diagram.providers.FuzzyAutomatonElementTypes.Input_3002, getParserElement(),
