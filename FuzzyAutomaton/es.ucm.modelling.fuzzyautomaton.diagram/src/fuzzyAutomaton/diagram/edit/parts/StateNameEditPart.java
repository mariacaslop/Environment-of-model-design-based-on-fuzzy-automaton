	...
	public IParser getParser() {
		if (parser == null) {
			parser = fuzzyAutomaton.diagram.providers.FuzzyAutomatonParserProvider.getParser(
					fuzzyAutomaton.diagram.providers.FuzzyAutomatonElementTypes.State_2001, getParserElement(),
					fuzzyAutomaton.diagram.part.FuzzyAutomatonVisualIDRegistry
							.getType(fuzzyAutomaton.diagram.edit.parts.StateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
