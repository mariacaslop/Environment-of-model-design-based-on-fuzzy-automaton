 ...
 * @generated
 */
public class FuzzyRelationTFRelationExpression1ExEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FuzzyRelationTFRelationExpression1ExEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new fuzzyAutomaton.diagram.edit.policies.FuzzyAutomatonTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return fuzzyAutomaton.diagram.providers.FuzzyAutomatonElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			...
			FuzzyRelation fuzzyRelation = (FuzzyRelation) parserElement;

			if (fuzzyRelation.getTFRelation() != null && fuzzyRelation.getDelta() != null) {

				if (fuzzyRelation.getTFRelation() != FuzzyRelationType.TERN) {

					if (fuzzyRelation.getExpression1() != null && fuzzyRelation.getExpression2() != null) {

						if (fuzzyRelation.getTFRelation() == FuzzyRelationType.EQ)
							operator = " = ";
						else if (fuzzyRelation.getTFRelation() == FuzzyRelationType.GTE)
							operator = " >= ";
						else if (fuzzyRelation.getTFRelation() == FuzzyRelationType.LTE)
							operator = " <= ";

						text = fuzzyRelation.getExpression1() + operator + fuzzyRelation.getExpression2() + "  ["
								+ fuzzyRelation.getDelta() + "]";
					} else
						text = defaultText;
				} else {
					if (fuzzyRelation.getExpression1() != null && fuzzyRelation.getExpression2() != null
							&& fuzzyRelation.getExpression3() != null) {

						text = fuzzyRelation.getExpression1() + " <= " + fuzzyRelation.getExpression2() + " <= "
								+ fuzzyRelation.getExpression3() + "  [" + fuzzyRelation.getDelta() + "]";
					} else
						text = defaultText;
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = fuzzyAutomaton.diagram.providers.FuzzyAutomatonParserProvider.getParser(
					fuzzyAutomaton.diagram.providers.FuzzyAutomatonElementTypes.FuzzyRelation_3005, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					fuzzyAutomaton.diagram.edit.parts.FuzzyAutomatonEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
