...
public class InputEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new fuzzyAutomaton.diagram.edit.policies.InputItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof fuzzyAutomaton.diagram.edit.parts.InputNameEditPart) {
			((fuzzyAutomaton.diagram.edit.parts.InputNameEditPart) childEditPart)
