...
public class VariableEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new fuzzyAutomaton.diagram.edit.policies.VariableItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof fuzzyAutomaton.diagram.edit.parts.VariableNameEditPart) {
			((fuzzyAutomaton.diagram.edit.parts.VariableNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureVariableLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(90, 25);
		return result;
	}
	...
	*/
	...
	public class VariableFigure extends RoundedRectangle {
		...
		public VariableFigure() {
			...
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(90), getMapMode().DPtoLP(25)));
			createContents();
		}
