 ...
 * @generated
 */
public class VariableSetNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public VariableSetNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = fuzzyAutomaton.diagram.providers.FuzzyAutomatonParserProvider.getParser(
					fuzzyAutomaton.diagram.providers.FuzzyAutomatonElementTypes.VariableSet_2002, getParserElement(),
