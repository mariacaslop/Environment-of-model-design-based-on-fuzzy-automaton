...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(fuzzyAutomaton.diagram.part.FuzzyAutomatonVisualIDRegistry
				.getType(fuzzyAutomaton.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID), new Point(0, 40));
	}
