 ...
 * @generated
 */
public class VarUpdateExpressionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public VarUpdateExpressionEditPart(View view) {
		super(view);
	}
	...
	*/
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			...
			VarUpdate varUpdate = (VarUpdate) parserElement;

			if (varUpdate.getVariable() != null && varUpdate.getVariable() != null) {

				text = varUpdate.getVariable().getName() + " := " + varUpdate.getExpression();
			} else
				text = defaultText;
		}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = fuzzyAutomaton.diagram.providers.FuzzyAutomatonParserProvider.getParser(
					fuzzyAutomaton.diagram.providers.FuzzyAutomatonElementTypes.VarUpdate_3007, getParserElement(),
