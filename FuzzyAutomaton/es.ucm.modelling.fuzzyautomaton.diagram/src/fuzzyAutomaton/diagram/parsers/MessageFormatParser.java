 ...
 * 
 */
package fuzzyAutomaton.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(fuzzyAutomaton.diagram.part.FuzzyAutomatonDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(fuzzyAutomaton.diagram.part.Messages.MessageFormatParser_InvalidInputError,
