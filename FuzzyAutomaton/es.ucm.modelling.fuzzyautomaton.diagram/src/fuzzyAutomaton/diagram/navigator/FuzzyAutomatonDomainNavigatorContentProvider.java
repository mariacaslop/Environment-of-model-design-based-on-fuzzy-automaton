 ...
 * @generated
 */
public class FuzzyAutomatonDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public FuzzyAutomatonDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof fuzzyAutomaton.diagram.navigator.FuzzyAutomatonDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((fuzzyAutomaton.diagram.navigator.FuzzyAutomatonDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new fuzzyAutomaton.diagram.navigator.FuzzyAutomatonDomainNavigatorItem((EObject) objects[i],
