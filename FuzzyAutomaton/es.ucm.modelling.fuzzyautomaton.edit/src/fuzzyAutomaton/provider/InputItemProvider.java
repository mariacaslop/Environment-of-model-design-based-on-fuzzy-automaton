...
/**
 * This is the item provider adapter for a {@link fuzzyAutomaton.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_parameters_feature", "_UI_Input_type"),
				 FuzzyAutomatonPackage.Literals.INPUT__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
