...
/**
 * This is the item provider adapter for a {@link fuzzyAutomaton.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FuzzyAutomatonPackage.Literals.TRANSITION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FuzzyAutomatonPackage.Literals.TRANSITION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_feature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_feature_feature", "_UI_Transition_type"),
				 FuzzyAutomatonPackage.Literals.TRANSITION__FEATURE,
				 true,
				 false,
				 true,
				 null,
