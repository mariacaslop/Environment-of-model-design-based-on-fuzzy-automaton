...
/**
 * This is the item provider adapter for a {@link fuzzyAutomaton.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider extends ActionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_expression_feature", "_UI_Output_type"),
				 FuzzyAutomatonPackage.Literals.OUTPUT__EXPRESSION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Output.class)) {
			case FuzzyAutomatonPackage.OUTPUT__EXPRESSION:
